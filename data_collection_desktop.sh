...
dp=$(timeout 40 python parse_deepcrawl_output.py './desktop_deepcrawl_results/trial'$trial'_run'$run'_deepcrawl_inclusions_top'$rank'.json' $path$rank'_alldetails.txt' $path$rank'_alledges.txt' $path$rank'_allresources.txt' $path$rank'_alldomains.txt')
...
zb=$(timeout 40 python parse_zbrowse_output.py './desktop_zbrowse_results/trial'$trial'_run'$run'_zbrowse_top'$rank'.json' $f'_alldetails.txt' $f'_alledges.txt' $f'_allresources.txt' $f'_alldomains.txt')
